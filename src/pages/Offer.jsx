...
function Offer() {
    const services = [
        { icon: <FaMobileAlt />, title: "Responsive Design", description: "Crafting pixel-perfect websites that provide an optimal viewing experience across all devices." },
        { icon: <FaLayerGroup />, title: "UI Development", description: "Building dynamic, engaging, and user-friendly interfaces using modern frameworks." },
        { icon: <FaBolt />, title: "Performance", description: "Optimizing web applications for maximum speed and SEO efficiency." }
    ];
                ...
                >
                   {services.map((service, i) => ( 
                    <motion.div 
                        ...
                        className='group relative bg-slate-900/90 md:bg-slate-900/40 md:backdrop-blur-md border border-white/5 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300 hover:-translate-y-2 overflow-hidden'
                    >
