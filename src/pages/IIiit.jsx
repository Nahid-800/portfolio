...
// Social media icons component for cleaner code
...
<div>
  ...
  <ul className="mt-4 space-y-2">
    {list.map((item, i) => (
    <li key={i}>
      <a href="#" className="text-gray-400 hover:text-white text-base transition-colors duration-300">
        {item}
      </a>
    </li>
    ))}
...
<footer className="bg-gray-900 text-gray-300">
  <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col sm:flex-row-reverse sm:justify-between items-center">
