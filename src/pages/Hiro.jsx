...
function Hiro() {
    return (
        // মোবাইল এবং ডেস্কটপের জন্য রেসপন্সিভ প্যাডিং যুক্ত করা হয়েছে
            ...
            */}
            <div className='container mx-auto flex flex-col md:flex-row items-center justify-center gap-10 md:gap-8'>
                ...
                */}
                ...
                {/* === ইমেজ সেকশন === */}
                {/* 
                  এখানে '-mt-12' কে পরিবর্তন করে '-mt-20' করা হয়েছে।
                  আপনি চাইলে 20 এর জায়গায় অন্য সংখ্যা (যেমন: 16, 24, 28) ব্যবহার করে দেখতে পারেন।
                */}
