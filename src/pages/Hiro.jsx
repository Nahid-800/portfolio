...
function Hiro() {
    ...
    return (
        <>
            <section className='flex justify-between items-center flex-col-reverse md:flex-row py-40 min-h-screen'>
                <div className='flex justify-center items-center md:items-start gap-12 md:justify-between flex-col-reverse md:flex-row w-full md:px-24'>
                    ...
                    <div className='flex-1'>
                        <div className='text-center md:text-start px-5 flex flex-col gap-3 md:gap-4' >
                            ...
                            <p className="text-lg md:text-2xl lg:text-3xl font-[500] mt-2 max-w-xl h-16 md:h-auto whitespace-nowrap">
                            ...
                            <div className='flex gap-4 justify-center md:justify-start pb-4 '>
                                <a href="https://www.facebook.com/m.aul.ulla.2024" target="_blank" rel="noopener noreferrer">
                                    <button className='icons text-cyan-500 text-3xl transform hover:scale-125 hover:text-blue-600 transition-all duration-300'><i className="fa-brands fa-facebook-f"></i></button>
                                </a>
                                <a href="https://www.instagram.com/auly_ullah?igsh=MTFocm13ZHBlOWQ4ag==" target="_blank" rel="noopener noreferrer">
                                    <button className='icons text-cyan-500 text-3xl transform hover:scale-125 hover:text-pink-500 transition-all duration-300'><i className="fa-brands fa-instagram"></i></button>
                                </a>
                                <a href="https://www.youtube.com/@CodedByAuly" target="_blank" rel="noopener noreferrer">
                                    <button className='icons text-cyan-500 text-3xl transform hover:scale-125 hover:text-red-600 transition-all duration-300'><i className="fa-brands fa-youtube"></i></button>
                                </a>
                                <a href="https://www.linkedin.com/in/auly-ullah-244604352?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer">
                                    <button className='icons text-cyan-500 text-3xl transform hover:scale-125 hover:text-blue-700 transition-all duration-300'><i className="fa-brands fa-linkedin-in"></i></button>
                                </a>
                               <a href="https://www.tiktok.com/@codedbyauly?_t=ZS-8vLC83UDfLs&_r=1" target="_blank" rel="noopener noreferrer">
                                   <button className='icons text-cyan-500 text-3xl transform hover:scale-125 hover:text-black transition-all duration-300'><i className="fa-brands fa-tiktok"></i></button>
                               </a>
                            </div>
