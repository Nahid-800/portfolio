...
function Workflow() {
    const steps = [
        { id: "01", title: "Planning", description: "Analyzing requirements and creating a roadmap.", icon: <FaLightbulb /> },
        { id: "02", title: "Design", description: "Creating wireframes and high-fidelity UI designs.", icon: <FaDraftingCompass /> },
        { id: "03", title: "Development", description: "Writing clean, scalable code with modern stacks.", icon: <FaCode /> },
        { id: "04", title: "Launch", description: "Testing, optimization, and deployment.", icon: <FaRocket /> }
    ];

    return (
        <section className="relative w-full py-20 md:py-32 bg-transparent" id="workflow">
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    {steps.map((step, index) => (
                        <motion.div 
                            ...
                            className="group relative bg-slate-900/90 md:bg-slate-900/40 md:backdrop-blur-sm border border-white/5 p-6 pt-10 rounded-2xl hover:border-orange-500/30 transition-all duration-300 hover:-translate-y-2"
                        >
